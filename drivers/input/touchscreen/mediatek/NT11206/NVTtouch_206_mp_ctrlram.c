 ...
 *
 * $Revision: 8272 $
 * $Date: 2016-12-26 10:35:48 +0800 (週一, 26 十二月 2016) $
 *
...
static uint8_t AIN_RX[IC_RX_CFG_SIZE] = {28, 29, 26, 18, 17, 16, 24, 19, 27, 14, 25, 22, 11, 21, 20, 8, 7, 9, 5, 6, 10, 4, 3, 13, 15, 12, 2, 23, 1, 0xFF, 0xFF, 0, 0xFF};
static uint8_t AIN_TX[IC_TX_CFG_SIZE] = {9, 11, 10, 12, 8, 13, 6, 5, 7, 0, 4, 3, 2, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 1, 0xFF};
static uint8_t AIN_RX_Order[IC_RX_CFG_SIZE] = {0};
static uint8_t AIN_TX_Order[IC_TX_CFG_SIZE] = {0};
#if TOUCH_KEY_NUM > 0
static uint8_t AIN_KEY_RX[IC_RX_CFG_SIZE] = {0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF};
static uint8_t AIN_KEY_TX[IC_TX_CFG_SIZE] = {0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF};
...
int32_t nvt_load_mp_criteria(void)
{
	...
	mm_segment_t org_fs;
/*[Arima_8100][bozhi_lin] change Novatek nt11206 touch aats csv file path to sdcard 20170320 begin*/
	char file_path[64]="/sdcard/MP_Criteria_Golden.csv";
/*[Arima_8100][bozhi_lin] 20170320 end*/
	...
	if (!retval) {
		...
		if (read_ret > 0) {
			...
			if (!test_cmd_buf) {
				NVT_ERR("kzalloc for test_cmd_buf failed.\n");
				retval = -ENOMEM;
				goto exit_free;
			}
			...
			while ( ptr && (ptr < (fbufp + stat.size))) {
				if (mp_criteria_item == GND_Ch_Real) {
					...
					NVT_LOG("PSConfig_Tolerance_Postive_Short = %d\n", PSConfig_Tolerance_Postive_Short);
					...
					NVT_LOG("PSConfig_Tolerance_Negativee_Short = %d\n", PSConfig_Tolerance_Negative_Short);
					...
					NVT_LOG("PSConfig_DiffLimitG_Postive_Short = %d\n", PSConfig_DiffLimitG_Postive_Short );
					...
					NVT_LOG("PSConfig_DiffLimitG_Negative_Short = %d\n", PSConfig_DiffLimitG_Negative_Short);
					...
					NVT_LOG("PSConfig_Tolerance_Postive_Mutual = %d\n", PSConfig_Tolerance_Postive_Mutual);
					...
					NVT_LOG("PSConfig_Tolerance_Negative_Mutual = %d\n", PSConfig_Tolerance_Negative_Mutual);
					...
					NVT_LOG("PSConfig_DiffLimitG_Postive_Mutual = %d\n", PSConfig_DiffLimitG_Postive_Mutual);
					...
					NVT_LOG("PSConfig_DiffLimitG_Negative_Mutual = %d\n", PSConfig_DiffLimitG_Negative_Mutual);
					...
					NVT_LOG("PSConfig_Rawdata_Limit_Postive_Short_RXRX = %d\n", PSConfig_Rawdata_Limit_Postive_Short_RXRX);
					...
					NVT_LOG("PSConfig_Rawdata_Limit_Negative_Short_RXRX = %d\n", PSConfig_Rawdata_Limit_Negative_Short_RXRX);
					...
					NVT_LOG("PSConfig_Rawdata_Limit_Postive_Short_TXRX = %d\n", PSConfig_Rawdata_Limit_Postive_Short_TXRX);
					...
					NVT_LOG("PSConfig_Rawdata_Limit_Negative_Short_TXRX = %d\n", PSConfig_Rawdata_Limit_Negative_Short_TXRX);
					...
					NVT_LOG("PSConfig_Rawdata_Limit_Postive_Short_TXTX = %d\n", PSConfig_Rawdata_Limit_Postive_Short_TXTX);
					...
					NVT_LOG("PSConfig_Rawdata_Limit_Negative_Short_TXTX = %d\n", PSConfig_Rawdata_Limit_Negative_Short_TXTX);
#if TOUCH_KEY_NUM > 0
					...
					NVT_LOG("PSConfig_Tolerance_Postive_Key_Open = %d\n", PSConfig_Tolerance_Postive_Key_Open);
					...
					NVT_LOG("PSConfig_Tolerance_Negative_Key_Open = %d\n", PSConfig_Tolerance_Negative_Key_Open);
					...
					NVT_LOG("PSConfig_DiffLimitG_Postive_Key_Open = %d\n", PSConfig_DiffLimitG_Postive_Key_Open);
					...
					NVT_LOG("PSConfig_DiffLimitG_Negative_Key_Open = %d\n", PSConfig_DiffLimitG_Negative_Key_Open);
					...
					NVT_LOG("PSConfig_Tolerance_Postive_Key_Short = %d\n", PSConfig_Tolerance_Postive_Key_Short);
					...
					NVT_LOG("PSConfig_Tolerance_Negative_Key_Short = %d\n", PSConfig_Tolerance_Negative_Key_Short);
					...
					NVT_LOG("PSConfig_DiffLimitG_Postive_Key_Short = %d\n", PSConfig_DiffLimitG_Postive_Key_Short);
					...
					NVT_LOG("PSConfig_DiffLimitG_Negative_Key_Short = %d\n", PSConfig_DiffLimitG_Negative_Key_Short);
					...
					NVT_LOG("PSConfig_Rawdata_Limit_Postive_Key_Short_RXRX = %d\n", PSConfig_Rawdata_Limit_Postive_Key_Short_RXRX);
					...
					NVT_LOG("PSConfig_Rawdata_Limit_Negative_Key_Short_RXRX = %d\n", PSConfig_Rawdata_Limit_Negative_Key_Short_RXRX);
					...
					NVT_LOG("PSConfig_Rawdata_Limit_Postive_Key_Short_TXRX = %d\n", PSConfig_Rawdata_Limit_Postive_Key_Short_TXRX);
					...
					NVT_LOG("PSConfig_Rawdata_Limit_Negative_Key_Short_TXRX = %d\n", PSConfig_Rawdata_Limit_Negative_Key_Short_TXRX);
					...
					NVT_LOG("PSConfig_Rawdata_Limit_Postive_Key_Short_TXTX = %d\n", PSConfig_Rawdata_Limit_Postive_Key_Short_TXTX);
					...
					NVT_LOG("PSConfig_Rawdata_Limit_Negative_Key_Short_TXTX = %d\n", PSConfig_Rawdata_Limit_Negative_Key_Short_TXTX);
#endif /* #if TOUCH_KEY_NUM > 0 */
				} else if (mp_criteria_item == Open_rawdata) {
					ptr = fbufp;
					NVT_LOG("load golden Open rawdata:\n");
					ptr = strstr(ptr, "Open rawdata:");
					if (ptr == NULL) {
						NVT_ERR("load golden Open rawdata failed!\n");
						retval = -5;
						goto exit_free;
					}
					// walk thru this line
					...
					ptr = fbufp;
					NVT_LOG("load golden RX-RX rawdata:\n");
					ptr = strstr(ptr, "RX-RX rawdata:");
					if (ptr == NULL) {
						NVT_ERR("load golden RX-RX rawdata failed!\n");
						retval = -8;
						goto exit_free;
					}
					// walk thru this line
					...
					if (j != (AIN_RX_NUM + GND_Channel_Real)) {
						NVT_ERR("load golden RX-RX rawdata failed!, j=%d, (AIN_RX_NUM + GND_Channel_Real)=%d\n", j, (AIN_RX_NUM + GND_Channel_Real));
						retval = -10;
						goto exit_free;
					}
					// go forward
					...
					ptr = fbufp;
					NVT_LOG("load golden TX-RX rawdata:\n");
					ptr = strstr(ptr, "TX-RX rawdata:");
					if (ptr == NULL) {
						NVT_ERR("load golden TX-RX rawdata failed!\n");
						retval = -11;
						goto exit_free;
					}
					// walk thru this line
					...
					ptr = fbufp;
					NVT_LOG("load golden TX-TX rawdata:\n");
					ptr = strstr(ptr, "TX-TX rawdata:");
					if (ptr == NULL) {
						NVT_ERR("load golden TX-TX rawdata failed!\n");
						retval = -14;
						goto exit_free;
					}
					// walk thru this line
					...
					printk("\n");
					if (j != AIN_TX_NUM) {
						NVT_ERR("load golden TX-TX rawdata failed!, j=%d, AIN_TX_NUM=%d\n", j, AIN_TX_NUM);
						retval = -16;
						goto exit_free;
					}
					// go forward
					...
					ptr = fbufp;
					NVT_LOG("load golden Key open rawdata:\n");
					ptr = strstr(ptr, "Key open rawdata:");
					if (ptr == NULL) {
						NVT_ERR("load golden Key open rawdata failed!\n");
						retval = -17;
						goto exit_free;
					}
					// walk thru this line
					...
					ptr = fbufp;
					NVT_LOG("load golden Key short RXRX rawdata:\n");
					ptr = strstr(ptr, "Key short RXRX rawdata:");
					if (ptr == NULL) {
						NVT_ERR("load golden Key short RXRX rawdata failed!\n");
						retval = -19;
						goto exit_free;
					}
					// walk thru this line
					...
					ptr = fbufp;
					NVT_LOG("load golden Key short TXRX rawdata:\n");
					ptr = strstr(ptr, "Key short TXRX rawdata:");
					if (ptr == NULL) {
						NVT_ERR("load golden Key short TXRX rawdata failed!\n");
						retval = -21;
						goto exit_free;
					}
					// walk thru this line
					...
					ptr = fbufp;
					NVT_LOG("load golden Key short TXTX rawdata:\n");
					ptr = strstr(ptr, "Key short TXTX rawdata:");
					if (ptr == NULL) {
						NVT_ERR("load golden Key short TXTX rawdata failed!\n");
						retval = -23;
						goto exit_free;
					}
					// walk thru this line
					...
					ptr = fbufp;
					NVT_LOG("load test_cmd_short_test_rxrx:\n");
					if (parse_mp_criteria_item(&ptr, "test_cmd_short_test_rxrx:", &test_cmd_num) < 0) {
						NVT_ERR("load test_cmd_short_test_rxrx failed\n");
						retval = -25;
						goto exit_free;
					}
					NVT_LOG("test_cmd_num = %d\n", test_cmd_num);
					...
					if (!short_test_rxrx) {
						NVT_ERR("kzalloc for short_test_rxrx failed.\n");
						retval = -ENOMEM;
						goto exit_free;
					}
					// load test commands
					for (i = 0; i < test_cmd_num; i++) {
						...
						if (j != short_test_rxrx[i].len) {
							NVT_ERR("command data and length loaded not match!!!, j=%d, short_test_rxrx[%d].len=%d\n", j, i, short_test_rxrx[i].len);
							retval = -26;
							goto exit_free;
						}
					}
					...
					ptr = fbufp;
					NVT_LOG("load test_cmd_short_test_txrx:\n");
					if (parse_mp_criteria_item(&ptr, "test_cmd_short_test_txrx:", &test_cmd_num) < 0) {
						NVT_ERR("load test_cmd_short_test_txrx failed!\n");
						retval = -27;
						goto exit_free;
					}
					NVT_LOG("test_cmd_num = %d\n", test_cmd_num);
					...
					if (!short_test_txrx) {
						NVT_ERR("kzalloc for short_test_txrx failed.\n");
						retval = -ENOMEM;
						goto exit_free;
					}
					// load test commands
					for (i = 0; i < test_cmd_num; i++) {
						...
						if (j != short_test_txrx[i].len) {
							NVT_ERR("command data and length loaded not match!!!, j=%d, short_test_txrx[%d].len=%d\n", j, i, short_test_txrx[i].len);
							retval = -28;
							goto exit_free;
						}
					}
					...
					ptr = fbufp;
					NVT_LOG("load test_cmd_short_test_txtx:\n");
					if (parse_mp_criteria_item(&ptr, "test_cmd_short_test_txtx:", &test_cmd_num) < 0) {
						NVT_ERR("load test_cmd_short_test_txtx failed!\n");
						retval = -29;
						goto exit_free;
					}
					NVT_LOG("test_cmd_num = %d\n", test_cmd_num);
					...
					if (!short_test_txtx) {
						NVT_ERR("kzalloc for short_test_txtx failed.\n");
						retval = -ENOMEM;
						goto exit_free;
					}
					// load test commands
					for (i = 0; i < test_cmd_num; i++) {
						...
						if (j != short_test_txtx[i].len) {
							NVT_ERR("command data and length loaded not match!!!, j=%d, short_test_txtx[%d].len=%d\n", j, i, short_test_txtx[i].len);
							retval = -30;
							goto exit_free;
						}
					}
					...
					ptr = fbufp;
					NVT_LOG("load test_cmd_open_test:\n");
					if (parse_mp_criteria_item(&ptr, "test_cmd_open_test:", &test_cmd_num) < 0) {
						NVT_ERR("load test_cmd_open_test failed!\n");
						retval = -31;
						goto exit_free;
					}
					NVT_LOG("test_cmd_num = %d\n", test_cmd_num);
					...
					if (!open_test) {
						NVT_ERR("kzalloc for open_test failed\n");
						retval = -ENOMEM;
						goto exit_free;
					}
					// load test commands
					for (i = 0; i < test_cmd_num; i++) {
						...
						if (j != open_test[i].len) {
							NVT_ERR("command data and length loaded not match!!!, j=%d, open_test[%d].len=%d\n", j, i, open_test[i].len);
							retval = -32;
							goto exit_free;
						}
					}
					...
					NVT_LOG("Mutual_isReadADCCheck = %d\n", Mutual_isReadADCCheck);
		...
		if (read_ret > 0) {
			...
			while ( ptr && (ptr < (fbufp + stat.size))) {
				if (ctrl_ram_item == CtrlRam_REGISTER) {
					...
					NVT_LOG("ctrlram_table_number=%08X\n", ctrlram_table_number);
					...
					if (TXMODE_Table_Addr != ctrlram_cur_addr) {
						NVT_ERR("TXMODE Table Address not match!\n");
						retval = -9;
						goto exit_free;
					}
					ptr = strstr(ptr, "TXMODE_ADDR");
					if (ptr == NULL) {
						NVT_ERR("TXMODE_ADDR not found!\n");
						retval = -10;
						goto exit_free;
					}
					nvt_ctrlram_fill_cmd_table(&ptr, test_cmd_table, &ctrlram_cmd_table_idx, &ctrlram_cur_addr);
					...
					if (RXMODE_Table_Addr != ctrlram_cur_addr) {
						NVT_ERR("RXMODE Table Address not match!\n");
						retval = -11;
						goto exit_free;
					}
					ptr = strstr(ptr, "RXMODE_ADDR");
					if (ptr == NULL) {
						NVT_ERR("RXMODE_ADDR not found!\n");
						retval = -12;
						goto exit_free;
					}
					nvt_ctrlram_fill_cmd_table(&ptr, test_cmd_table, &ctrlram_cmd_table_idx, &ctrlram_cur_addr);
					...
					if (CCMODE_Table_Addr != ctrlram_cur_addr) {
						NVT_ERR("CCMODE Table Address not match!\n");
						retval = -13;
						goto exit_free;
					}
					ptr = strstr(ptr, "CCMODE_ADDR");
					if (ptr == NULL) {
						NVT_ERR("CCMODE_ADDR not found!\n");
						retval = -14;
						goto exit_free;
					}
					nvt_ctrlram_fill_cmd_table(&ptr, test_cmd_table, &ctrlram_cmd_table_idx, &ctrlram_cur_addr);
					...
					if (OFFSET_Table_Addr != ctrlram_cur_addr) {
						NVT_ERR("OFFSET Table Address not match!\n");
						retval = -15;
						goto exit_free;
					}
					ptr = strstr(ptr, "OFFSET_ADDR");
					if (ptr == NULL) {
						NVT_ERR("OFFSET_ADDR not found!\n");
						retval = -16;
						goto exit_free;
					}
					nvt_ctrlram_fill_cmd_table(&ptr, test_cmd_table, &ctrlram_cmd_table_idx, &ctrlram_cur_addr);
				...
				if (ctrl_ram_item == CtrlRam_ITEM_LAST) {
					*ctrlram_test_cmds_num = ctrlram_cmd_table_idx;
					NVT_LOG("ctrlram_test_cmds_num = %d\n", *ctrlram_test_cmds_num);
					NVT_LOG("Load control ram items finished\n");
					retval = 0;
					break;
				}
			}
...
static int32_t nvt_read_short_rxrx(void)
{
	...
	mm_segment_t org_fs;
/*[Arima_8100][bozhi_lin] change Novatek nt11206 touch aats csv file path to sdcard 20170320 begin*/
	char file_path[64]="/sdcard/ShortTestRX-RX.csv";
/*[Arima_8100][bozhi_lin] 20170320 end*/
	loff_t pos = 0;
	int32_t write_ret = 0;
	uint32_t output_len = 0;
/*[Arima_8100][bozhi_lin] change Novatek nt11206 touch aats csv file path to sdcard 20170320 begin*/
	char ctrlram_short_rxrx_file[64]="/sdcard/CtrlRAM_Short_RXRX.csv";
	char ctrlram_short_rxrx1_file[64]="/sdcard/CtrlRAM_Short_RXRX1.csv";
/*[Arima_8100][bozhi_lin] 20170320 end*/
	...
	if (!ctrlram_short_rxrx_cmds) {
		NVT_ERR("kzalloc for ctrlram_short_rxrx_cmds failed.\n");
		return -ENOMEM;
	}
	if (nvt_load_mp_ctrl_ram(ctrlram_short_rxrx_file, ctrlram_short_rxrx_cmds, &ctrlram_short_rxrx_cmds_num) < 0) {
		NVT_ERR("load control ram %s failed!\n", ctrlram_short_rxrx_file);
		if (ctrlram_short_rxrx_cmds) {
	...
	if (!ctrlram_short_rxrx1_cmds) {
		NVT_ERR("kzalloc for ctrlram_short_rxrx1_cmds failed.\n");
		if (ctrlram_short_rxrx_cmds) {
			kfree(ctrlram_short_rxrx_cmds);
			ctrlram_short_rxrx_cmds = NULL;
		}
...
static int32_t nvt_read_short_txrx(void)
{
	...
	mm_segment_t org_fs;
/*[Arima_8100][bozhi_lin] change Novatek nt11206 touch aats csv file path to sdcard 20170320 begin*/
	char file_path[64]="/sdcard/ShortTestTX-RX.csv";
/*[Arima_8100][bozhi_lin] 20170320 end*/
	loff_t pos = 0;
	int32_t write_ret = 0;
	uint32_t output_len = 0;
/*[Arima_8100][bozhi_lin] change Novatek nt11206 touch aats csv file path to sdcard 20170320 begin*/
	char ctrlram_short_txrx_file[64]="/sdcard/CtrlRAM_Short_TXRX.csv";
/*[Arima_8100][bozhi_lin] 20170320 end*/
	...
	if (!rawdata_buf) {
		NVT_ERR("allocated for rawdata_buf failed.\n");
		if (ctrlram_short_txrx_cmds) {
			kfree(ctrlram_short_txrx_cmds);
			ctrlram_short_txrx_cmds = NULL;
		}
...
static int32_t nvt_read_short_txtx(void)
{
	...
	mm_segment_t org_fs;
/*[Arima_8100][bozhi_lin] change Novatek nt11206 touch aats csv file path to sdcard 20170320 begin*/
	char file_path[64]="/sdcard/ShortTestTX-TX.csv";
/*[Arima_8100][bozhi_lin] 20170320 end*/
	loff_t pos = 0;
	int32_t write_ret = 0;
	uint32_t output_len = 0;
/*[Arima_8100][bozhi_lin] change Novatek nt11206 touch aats csv file path to sdcard 20170320 begin*/
	char ctrlram_short_txtx_file[64]="/sdcard/CtrlRAM_Short_TXTX.csv";
/*[Arima_8100][bozhi_lin] 20170320 end*/
...
static int32_t nvt_read_open(void)
{
	...
	mm_segment_t org_fs;
/*[Arima_8100][bozhi_lin] change Novatek nt11206 touch aats csv file path to sdcard 20170320 begin*/
	char file_path[64]="/sdcard/OpenTest.csv";
/*[Arima_8100][bozhi_lin] 20170320 end*/
	loff_t pos = 0;
	int32_t write_ret = 0;
	uint32_t output_len = 0;
/*[Arima_8100][bozhi_lin] change Novatek nt11206 touch aats csv file path to sdcard 20170320 begin*/
	char ctrlram_open_mutual_file[64]="/sdcard/CtrlRAM_Open_Mutual.csv";
/*[Arima_8100][bozhi_lin] 20170320 end*/
	...
	if (!rawdata_buf1) {
		NVT_ERR("kzalloc for rawdata_buf1 failed\n");
		if (ctrlram_open_mutual_cmds) {
			kfree(ctrlram_open_mutual_cmds);
			ctrlram_open_mutual_cmds = NULL;
		}
	...
	if (!rawdata_buf2) {
		NVT_ERR("kzalloc for rawdata_buf2 failed\n");
		if (ctrlram_open_mutual_cmds) {
			kfree(ctrlram_open_mutual_cmds);
			ctrlram_open_mutual_cmds = NULL;
		}
