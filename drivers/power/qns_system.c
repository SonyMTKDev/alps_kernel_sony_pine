...
#define CHARGE_CURRENT_PROP	POWER_SUPPLY_PROP_MAX_CHARGE_CURRENT  //POWER_SUPPLY_PROP_CONSTANT_CHARGE_CURRENT_MAX
...
static struct class_attribute qns_attrs[] = {
	...
	__ATTR(charge_voltage, 0644, NULL, qns_param_store),
