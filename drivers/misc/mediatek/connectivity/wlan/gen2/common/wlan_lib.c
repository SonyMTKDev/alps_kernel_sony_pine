...
//[SM31] Improve wifi performance begin
	DBGLOG(INIT, INFO, "MT6625L number: 0x%x.%x \n"
		, prAdapter->rVerInfo.u2FwOwnVersion
		, prAdapter->rVerInfo.u2FwOwnVersionExtend);
prAdapter->rVerInfo.u2FwOwnVersion=0xa71;
prAdapter->rVerInfo.u2FwOwnVersionExtend=0xf0;
//[SM31] Improve wifi performance end
