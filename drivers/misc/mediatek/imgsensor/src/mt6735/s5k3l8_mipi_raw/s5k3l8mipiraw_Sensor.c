...
static kal_uint8 s5k3l8_Module_id;//ModuleId+VcmId
...
//[SM31][Camera] Add Main Camera Driver S5K3L8 Person Liu 20170214 S
		...
		LOG_INF("imgsensor 0x%x sensor_id = 0x%x Module ID = 0x%x \n",imgsensor_info.sensor_id,*sensor_id,s5k3l8_Module_id);

		if(*sensor_id == 0x30C8)
			s5k3l8_Module_id = read_s5k3l8_otp_mtk_fmt();

		if((*sensor_id == 0x30C8) && (s5k3l8_Module_id != 0x61))
			{
				if(s5k3l8_Module_id == 0x0C)			
				*sensor_id = 0x30C9;
...
//[SM31][Camera] Add Main Camera Driver S5K3L8 Person Liu 20170214 S
            if (sensor_id == imgsensor_info.sensor_id) {
			s5k3l8_Module_id = read_s5k3l8_otp_mtk_fmt();
			if(s5k3l8_Module_id != 0x61){
				LOG_INF("Truly Module: Use 2nd or 3rd Driver\n");
				return ERROR_SENSOR_CONNECT_FAIL;
			}
			LOG_INF("s5k3l8 module id = 0x%x\n",s5k3l8_Module_id);
