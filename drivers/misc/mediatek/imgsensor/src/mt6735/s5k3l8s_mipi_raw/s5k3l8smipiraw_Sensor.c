...
#include "s5k3l8smipiraw_Sensor.h"
...
static kal_uint8 s5k3l8s_Module_id;//ModuleId+VcmId
...
#define LOG_1 LOG_INF("S5K3L8S,MIPI 4LANE\n")\
...
static imgsensor_info_struct imgsensor_info = { 
	.sensor_id = S5K3L8S_SENSOR_ID,		//Sensor ID Value: 0x30C8//record sensor id defined in Kd_imgsensor.h
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
    ...
    while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		if(*sensor_id == 0x30C8)
			s5k3l8s_Module_id = read_s5k3l8_otp_mtk_fmt();		

		if((*sensor_id == 0x30C8) && (s5k3l8s_Module_id != 0x61))
			{
				if(s5k3l8s_Module_id == 0x0C)
				        *sensor_id = 0x30C9;
