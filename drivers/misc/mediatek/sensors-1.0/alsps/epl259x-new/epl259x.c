...
#define LUX_PER_COUNT	625  //ALS lux per count
...
static int als_dynamic_intt_value[] = {1024, 32}; //match als_dynamic_intt_intt table
static int als_dynamic_intt_gain[] = {EPL_GAIN_LOW, EPL_GAIN_LOW};
static int als_dynamic_intt_high_thr[] = {60000, 60000};
static int als_dynamic_intt_low_thr[] = {0, 1200};
...
static bool read_factory_calibration(void)
{
    ...
    if(epl_sensor.als.factory.calibration_enable && !epl_sensor.als.factory.calibrated)
    {
        ...
        else
        {
            ...
            if((als_lux_per_count < 550) || (als_lux_per_count > 1000)){
...
//<--[SM31][Sensors][JasonHsing] Reduce P-sensor current by add wait time 20161229 BEGIN --
    epl_sensor.ps.integration_time = EPL_PS_INTT_48;
