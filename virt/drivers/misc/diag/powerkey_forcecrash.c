/*
 *  drivers/misc/diag/powerkey_forcecrash.c
 *
...
#define FORCE_BUG() *((unsigned *)0xaed) = 0xDEAD
...
MODULE_DESCRIPTION("Force crash on power key long press of 30 secs");
