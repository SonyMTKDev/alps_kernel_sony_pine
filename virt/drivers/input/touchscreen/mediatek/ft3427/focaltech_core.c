...
/*[Arima_8100][bozhi_lin] fine tune touch power-on sequency 20161024 begin*/
#if 0
#include <mt_gpio.h>
#define GPIO_TP_INT 10
#endif
...
/*[Arima_8100][bozhi_lin] disable touch driver event report log 20170223 begin*/
#define ENABLE_REPORT_LOG	0
...
static ssize_t show_Focal_FW(struct device *dev, struct device_attribute *attr, char *buf)
{
	ssize_t   ret = 0;
	u8 ver;
	fts_read_reg(i2c_client, 0xa6, &ver);
	fts_read_reg(fts_i2c_client, 0xa6, &ver);
	sprintf(buf, "FocalTech_0x%02X", ver);
	ret = strlen( buf) + 1;
	return ret;
}

static DEVICE_ATTR(fwversion, 0664, show_Focal_FW, NULL);
...
static struct attribute_group ft5x0x_attrs_group = {
	.attrs = ft5x0x_attrs,
};
#else
...
/*[Arima_8100][bozhi_lin] upgrade focaltech touch firmware to V05 20161005 begin*/
/*[Arima_8100][bozhi_lin] temp solution to rotate touch 180 degree 20160922 begin*/
//		data->au16_y[i] = TPD_RES_Y + 1 - data->au16_y[i];
//		data->au16_x[i] = TPD_RES_X + 1 - data->au16_x[i];
/*[Arima_8100][bozhi_lin] 20160922 end*/
/*[Arima_8100][bozhi_lin] 20161005 end*/
...
/*[Arima_8100][bozhi_lin] remove touch will send pressure 0 after resume 20161202 begin*/
#if 0
        ...
        input_sync(tpd->dev);
#endif
/*[Arima_8100][bozhi_lin] 20161202 end*/
...
/*[Arima_8100][bozhi_lin] touch set reset to low before vdd is off 20161117 begin*/
	tpd_gpio_output(tpd_rst_gpio_number, 0);
	msleep(1);
...
/*[Arima_8100][bozhi_lin] touch release all fingers before enter suspend 20170328 begin*/
	{
		int i = 0;
		for (i = 0; i < TPD_SUPPORT_POINTS; i++) {
			input_mt_slot(tpd->dev, i);
...
/*[Arima_8100][bozhi_lin] 20170328 end*/
...
/*[Arima_8100][bozhi_lin] 20170222 end*/
	...
	/*[Arima_8100][bozhi_lin] touch set GPIO_CTP_RSTB to low for meet power sequency 20161017 begin*/
	tpd_gpio_output(tpd_rst_gpio_number, 0);
	msleep(1);
	/*[Arima_8100][bozhi_lin] 20161017 end*/
...
/*[Arima_8100][bozhi_lin] Dynamic detect FocalTech and Novatek touch driver 20170222 begin*/
	...
	if (err < 0)
	{
		printk("[B]%s(%d): not FocalTech ft3427\n", __func__, __LINE__);
		goto err_check;
	}
/*[Arima_8100][bozhi_lin] 20170222 end*/

#if 0
	mt_set_gpio_mode(GPIO_TP_INT, GPIO_MODE_00);
	mt_set_gpio_dir(GPIO_TP_INT, GPIO_DIR_IN);
	mt_set_gpio_pull_enable(GPIO_TP_INT, GPIO_PULL_DISABLE);
#endif
/*[Arima_8100][bozhi_lin] 20161024 end*/
/*[Arima_8100][bozhi_lin] 20161101 end*/
...
/*[Arima_8100][bozhi_lin] modify touch pressure scale from 255 to 127 20161118 begin*/
		input_set_abs_params(tpd->dev, ABS_MT_PRESSURE, 0, 127, 0, 0);
/*[Arima_8100][bozhi_lin] 20161118 end*/
#else
...
/*[Arima_8100][bozhi_lin] 20161024 end*/
	...
	/*[Arima_8100][allen_yu] Eliminate frequent printing of errors about touch 20161227 begin*/
        //printk("err = %d", err);
          if (err < 0) 
			  return err;
    /*[Arima_8100][allen_yu] 20161227 end*/
...
/*[Arima_8100][bozhi_lin] store touch vendor and firmware version to tpd_show_vendor_firmware 20161011 begin*/
	#if defined(TPD_REPORT_VENDOR_FW)
	{
		...
		err = sysfs_create_group(&client->dev.kobj, &ft5x0x_attrs_group);
	}
	#endif
/*[Arima_8100][bozhi_lin] 20161011 end*/
...
#if 0
	mt_set_gpio_mode(GPIO_TP_INT, GPIO_MODE_00);
	mt_set_gpio_dir(GPIO_TP_INT, GPIO_DIR_OUT);
	mt_set_gpio_out(GPIO_TP_INT, GPIO_OUT_ZERO);
#endif
/*[Arima_8100][bozhi_lin] 20161024 end*/
/*[Arima_8100][bozhi_lin] 20161101 end*/
	return 0;
